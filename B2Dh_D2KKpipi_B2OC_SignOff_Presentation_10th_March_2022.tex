...
\begin{frame}{Summary of $\gamma$ analysis in $B^\pm\to Dh^\pm$, $D\to h^+h^-\pi^+\pi^-$}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item{$F_+$ for $D^0\to\pi^+\pi^-\pi^+\pi^-$ from CLEO-c data \href{https://arxiv.org/abs/1709.03467}{JHEP 01 (2018) 144}}
...
\begin{frame}{$s_i$ sign problem}
  ...
  \begin{enumerate}
    \setlength\itemsep{1.5em}
    \item{Preliminary BESIII results support LHCb model (but not conclusive...)}
